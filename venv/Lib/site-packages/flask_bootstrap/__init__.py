...
class Bootstrap(object):
    ...
    def init_app(self, app):
        ...
        bootstrap = lwrap(
            WebCDN('https://cdn.bootcss.com/bootstrap/%s/' %
                   BOOTSTRAP_VERSION), local)

        jquery = lwrap(
            WebCDN('https://cdn.bootcss.com/jquery/%s/' %
                   JQUERY_VERSION), local)

        html5shiv = lwrap(
            WebCDN('https://cdn.bootcss.com/html5shiv/%s/' %
                   HTML5SHIV_VERSION))

        respondjs = lwrap(
            WebCDN('https://cdn.bootcss.com/respond.js/%s/' %
                   RESPONDJS_VERSION))
